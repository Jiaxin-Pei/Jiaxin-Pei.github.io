...
<div style="display: flex; flex-wrap: wrap; align-items: center; gap: 14px 18px; padding: 14px 18px; margin: 1.5em 0; border: 1px solid #e5e5e5; border-radius: 8px;">
  ...
  <a href="https://texasinnovationcenter.utexas.edu" target="_blank" rel="noopener noreferrer" aria-label="Texas Innovation Center" style="display: flex; align-items: center; line-height: 0;">
    <img src="/images/txic-formal-rgb.svg" alt="Texas Innovation Center" style="display: block; width: auto; height: 36px;">
  </a>
